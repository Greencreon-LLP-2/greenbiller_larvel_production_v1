...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('purchase_return_items', function (Blueprint $table) {
            ...
            $table->index('purchase_item_id', 'idx_purchase_return_items_purchase_item_id');
            $table->index('item_id', 'idx_purchase_return_items_item_id');
    ...
    {
        Schema::dropIfExists('purchases_returns_items');
    }
};
